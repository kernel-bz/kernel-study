...
sudo cp $BUILD_PATH/arch/$ARCH/boot/Image $BUILD_PATH/mnt/fat32/$KERNEL.img
sudo cp $BUILD_PATH/arch/$ARCH/boot/dts/broadcom/*.dtb $BUILD_PATH/mnt/fat32/
...
echo "Done: umount $BUILD_PATH/mnt/"
