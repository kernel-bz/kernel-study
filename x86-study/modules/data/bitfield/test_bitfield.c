/**
    ...
    F:	linux-modules/data/bitfield/test_bitfield.c
    K:  /lib/test_bitfield.c
...
static int __init test_bitfields_init(void)
{
...
static void __exit test_bitfields_exit(void)
{
    pr_info("test_bitfields_exit()\n");
}

module_init(test_bitfields_init)
module_exit(test_bitfields_exit);
